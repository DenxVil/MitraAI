...
import pytest
from mitra.models import Message, MessageRole, Conversation, EmotionalContext, User, UserProfile
...
class TestMessage:
    ...
    def test_create_message(self):
        ...
        msg = Message(role=MessageRole.USER, content="Hello, Mitra!")
    ...
    def test_message_with_emotion(self):
        ...
        emotion = EmotionalContext(sentiment="positive", emotions=["joy"], intensity=0.8)

        msg = Message(role=MessageRole.USER, content="I'm so happy!", emotional_context=emotion)
